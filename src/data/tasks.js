...
const missionTasks = [
  ...
  {
    id: 'food-rolling-pantry-system',
    title: '建立滾動式備糧系統',
    system: 'food',
    riskLevel: 4,
    estimatedMinutes: 35,
    purpose: '不是單純囤貨，而是用日常會吃的食物建立吃掉、補上、輪替系統。',
    tools: ['庫存', '標籤貼紙', '保存期限', '每週菜單'],
    steps: ['列出家中平常真的會吃的主食、罐頭、乾糧、即食食品。', '將食物分為立即可吃、簡單加熱、需要烹調三類。', '在庫存中標記保存期限與免冷藏狀態。', '設定先到期先吃掉的輪替順序。', '每次吃掉一份後，在採買時補回一份。'],
    completion: '完成至少 7 天份可輪替食物，且每項都有保存期限或補貨規則。',
    failureConditions: ['只買平常不吃的防災食品。', '沒有保存期限。', '吃掉後沒有補回。'],
    relatedDrills: ['family-72h', 'remote-7d'],
    relatedGap: '食物補給中斷',
    xp: 35
  },
  {
    id: 'evac-10min-kit-test',
    title: '完成 10 分鐘撤離包測試',
    system: 'evacuation',
    riskLevel: 5,
    estimatedMinutes: 20,
    purpose: '確認撤離包不是清單上有，而是真正能在 10 分鐘內拿了就走。',
    tools: ['撤離包', '計時器', '鞋子', '鑰匙'],
    steps: ['設定 10 分鐘計時。', '從平常狀態開始，不預先把東西拿在手上。', '穿鞋、拿撤離包、拿手機、鑰匙與重要文件。', '背上撤離包走到門口或預定集合點。', '記錄卡住原因：太重、找不到、文件缺、動物無法快速裝籠。'],
    completion: '10 分鐘內能完成撤離準備，且撤離包重量在可接受範圍。',
    failureConditions: ['找不到撤離包。', '找不到文件或鑰匙。', '背包過重。', '動物無法快速控制或裝籠。'],
    relatedDrills: ['earthquake-72h', 'typhoon-24h', 'evac-kit-10min'],
    relatedGap: '撤離執行能力',
    xp: 40
  },
  {
    id: 'food-home-shelter-14d',
    title: '建立 14 天居家避難儲備',
    system: 'food',
    riskLevel: 5,
    estimatedMinutes: 45,
    purpose: '當住處安全但外部補給中斷時，能在家維持 14 天基本生活。',
    tools: ['庫存', '硬核計算器', '物資輪替表'],
    steps: ['估算家庭成員與動物 14 天最低飲水與食物需求。', '在庫存中標記飲水、免冷藏食物、常用藥、動物補給。', '區分撤離包與居家儲備，不把兩者混在一起。', '建立每週檢查與每月輪替節奏。'],
    completion: '庫存中有 14 天最低飲水或補水方案、14 天食物、常用藥與動物補給計畫。',
    failureConditions: ['只準備撤離包，沒有居家避難儲備。', '物資過期。', '動物或慢性病用藥未納入。'],
    relatedDrills: ['remote-7d', 'home-shelter-14d'],
    relatedGap: '長期補給中斷',
    xp: 45
  },
  {
    id: 'power-darkout-30min-drill',
    title: '完成黑暗停電演練',
    system: 'power',
    riskLevel: 4,
    estimatedMinutes: 35,
    purpose: '模擬夜間停電，確認照明、通訊、動線與動物安全。',
    tools: ['手電筒', '頭燈', '行動電源', '紙本聯絡人'],
    steps: ['在安全情況下關閉主要照明 30 分鐘。', '只使用預備照明移動。', '檢查夜間動線是否有障礙。', '測試手機省電模式與行動電源。', '確認動物位置與夜間溫控需求。'],
    completion: '30 分鐘內能維持基本照明、通訊與安全動線。',
    failureConditions: ['找不到照明。', '行動電源沒電。', '夜間動線有障礙。', '動物在黑暗中無法安全控制。'],
    relatedDrills: ['power-12h', 'darkout-30min'],
    relatedGap: '停電夜間安全',
    xp: 35
  },
  {
    id: 'terrain-typhoon-home-check',
    title: '完成防颱前屋內外檢查',
    system: 'terrain',
    riskLevel: 4,
    estimatedMinutes: 35,
    purpose: '颱風前完成固定、排水、補給、充電與停止外出條件。',
    tools: ['手冊', '演練', '庫存'],
    steps: ['固定陽台與戶外物品。', '清理排水孔與排水溝。', '檢查窗戶、門縫與可能進水處。', '補足飲水與免冷藏食物。', '充滿手機與行動電源。', '設定停止外出條件。'],
    completion: '颱風前 24 小時檢查表完成，且已設定不外出的停止條件。',
    failureConditions: ['強風豪雨時才外出處理。', '排水孔未檢查。', '戶外物品未固定。', '動物安置未確認。'],
    relatedDrills: ['typhoon-24h', 'coastal-typhoon'],
    relatedGap: '颱風應對',
    xp: 35
  },
  {
    id: 'evac-route-walk-scout',
    title: '完成逃生路線散步偵察',
    system: 'evacuation',
    riskLevel: 4,
    estimatedMinutes: 45,
    purpose: '不是只在地圖上看路線，而是實際走過，找出障礙、坡度、淹水點與夜間風險。',
    tools: ['紙本地圖', '手機', '筆記'],
    steps: ['選定住家到集合點或避難點的第一路線。', '實際步行一次。', '記錄坡度、狹窄處、淹水點、施工、夜間照明、動物通行問題。', '設定第二路線。', '將路線寫入紙本資料。'],
    completion: '至少完成一條主要路線與一條替代路線，並記錄風險點。',
    failureConditions: ['只有地圖路線，沒有實際走過。', '沒有替代路線。', '夜間或動物撤離問題未考慮。'],
    relatedDrills: ['earthquake-72h', 'mountain-rain'],
    relatedGap: '撤離路線',
    xp: 35
  },
  {
    id: 'food-semiannual-supply-audit',
    title: '完成半年物資檢查',
    system: 'food',
    riskLevel: 3,
    estimatedMinutes: 40,
    purpose: '避免物資過期、壞掉、漏補，讓防災準備維持可用狀態。',
    tools: ['庫存', '撤離包', '報告'],
    steps: ['檢查撤離包所有保存期限。', '檢查居家庫存保存期限。', '把 30 天內到期物資排入日常使用。', '替換已過期、破損或不適合的物品。', '更新報告並複製給家人。'],
    completion: '撤離包與庫存都沒有已過期物資，且即期物資已有輪替計畫。',
    failureConditions: ['物資過期仍留在包內。', '只檢查撤離包，不檢查居家庫存。', '沒有通知家人位置與內容。'],
    relatedDrills: ['family-72h'],
    relatedGap: '物資輪替',
    xp: 30
  }
]
