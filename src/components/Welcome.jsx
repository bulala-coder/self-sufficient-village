  ...
  return <div className="min-h-screen ink-page flex items-center justify-center px-4 py-10">
    <div className="shanshui-hero card max-w-4xl w-full p-8 md:p-12">
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="brush-chip mt-8">Fortress OS｜v6.0 RC</p>
        <h1 className="text-5xl md:text-7xl font-black text-[#171f1b] mt-6 leading-tight tracking-widest">Fortress OS｜自足堡壘</h1>
        <p className="text-xl md:text-2xl text-[#5f4b35] mt-4 font-semibold">家庭韌性與自給自足作戰系統</p>
        ...
        <div className="flex items-center gap-5 mt-9">
          <button className="brush-button" onClick={onStart}>開始建立家庭堡壘</button>
