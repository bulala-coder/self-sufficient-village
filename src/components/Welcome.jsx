  ...
  return <div className="min-h-screen ink-page flex items-center justify-center px-4 py-10">
    <div className="shanshui-hero card max-w-4xl w-full p-8 md:p-12">
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="brush-chip mt-8">山水墨畫版</p>
        <h1 className="text-5xl md:text-7xl font-black text-[#171f1b] mt-6 leading-tight tracking-widest">自足村</h1>
        <p className="text-xl md:text-2xl text-[#735d43] mt-4 font-semibold">Self-Sufficient Village</p>
        <p className="text-2xl md:text-3xl text-[#251c16] mt-8 font-black leading-relaxed">從一盆蔥開始，學會照顧自己的生活。</p>
        <p className="text-[#6f5b43] mt-5 leading-8 text-lg font-semibold">依你的生活地形，建立種植、食物保存、水與能源、健康急救、動物照護與風險應對能力。</p>
        <div className="flex items-center gap-5 mt-9">
          <button className="brush-button" onClick={onStart}>開始建立我的自足村</button>
          <div className="red-seal text-[12px]">自足<br/>村印</div>
        </div>
      </div>
    </div>
  </div>
