...
export default function Dashboard({ state, tasks, completedCount, setPage }) {
  ...
  const todayActions = [...new Set([
    ...
    communication.score < 50 ? communication.recommendations[0] : null,
    ...core.recommendations
  ].filter(Boolean))].slice(0, 3)
  const quickEntries = [['waterSystem','水資源系統','Water System'],['energySystem','能源系統','Energy System'],['sanitationSystem','衛生系統','Sanitation System'],['medicalSystem','醫療系統','Medical System'],['foodSystem','食物系統','Food System'],['communicationSystem','通訊系統','Communication System'],['inventory','庫存管理','Inventory'],['risk','風險矩陣','Risk Matrix'],['drills','情境演練','Drills'],['report','作戰報告','Report'],['roadmap','韌性路線','Roadmap']]
